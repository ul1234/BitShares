...
REGISTER_DB_OBJECT(encrypted_message,0)
...
fc::uint128   encrypted_message0::id()const
{
...
bool  encrypted_message0::decrypt( const fc::ecc::private_key& with, decrypted_message& m )const
{
  try 
  {
 ...
 */
bool  encrypted_message0::do_proof_work( uint64_t tar_per_kb )
{
...
bool encrypted_message0::validate_proof()const
{
...
uint64_t encrypted_message0::difficulty()const
{
